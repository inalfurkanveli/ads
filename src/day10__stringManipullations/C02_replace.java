...
public class C02_replace {
    public static void main(String[] args) {
        ...
        String sonuc="1-16 of over 100,000 results for \"keybord\"";
       ...
       int aramaSonucuInt = Integer.valueOf(sonucSayisiStr);
        System.out.println(aramaSonucuInt);
        if(aramaSonucuInt>10000){
