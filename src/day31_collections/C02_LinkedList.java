...
public class C02_LinkedList {
    public static void main(String[] args) {
        /*
        List data türünde bir linkedList olusturalım.
        ...
        System.out.println(karakterler); // [*, $, -, £, 9]

        System.out.println(harfler.retainAll(karakterler)); // true

        System.out.println(harfler); // [M] ortak elementler dışındaki herşeyi sildi.

        harfler.addAll(karakterler); // harfler linkedList'ine karakterleri ekledi.
        ...
        System.out.println(harfler.hashCode()); // 1

        System.out.println(karakterler.hashCode()); // 68568616
